...
``` {.bash filename="Code"}
checkm lineage_wf -x fa results/binning/assembly_ERR5000342.fasta.metabat-bins1500-YYYYMMDD_HHMMSS/ results/checkm/ --reduced_tree -t 4 --tab_table -f MAGs_checkm.tsv &> results/checkm/checkm.out &
```
...
So how can you make your bin outputs more reliable? There are ways of combining outputs from different binning tools which can help crosscheck results and refine your bins.
