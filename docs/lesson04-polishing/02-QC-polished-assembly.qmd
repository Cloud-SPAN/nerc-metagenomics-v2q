...
``` {.bash filename="Code"}
metaquast.py --references-list data/ref_genomes/reference_genomes.txt results/assembly/assembly.fasta results/medaka/consensus.fasta results/pilon/pilon.fasta &> results/metaquast/metaquast.out &
```
...
``` {.default filename="Output"}
[2]+  Done   metaquast.py --references-list data/ref_genomes/reference_genomes.txt results/assembly/assembly.fasta results/medaka/consensus.fasta results/pilon/pilon.fasta &> results/metaquast/metaquast.out & 
```
...
``` {.default filename="Output"}
MetaQUAST finished.
  Log is saved to /home/csuser/cs_course/results/metaquast/quast_results/results_YYYY_MM_DD_HH_MM_SS/metaquast.log
...
``` {.bash filename="Code"}
scp -i login-key-instanceNNN.pem csuser@instanceNNN.cloud-span.aws.york.ac.uk:~/cs_course/results/metaquast/quast_results/results_YYYY_MM_DD_HH_MM_SS/report.html .
```
