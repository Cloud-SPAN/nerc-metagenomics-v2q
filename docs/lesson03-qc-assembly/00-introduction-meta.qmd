...
::: {#second-column}
![Flow diagram that shows the steps: Sequence reads, Quality control, Assembly, Binning and Taxonomy](/images/metagenomics_flowchart_short.png){fig-align="right" width="300" height="450" fig-alt="Flow diagram that shows the steps: Sequence reads, Quality control, Assembly, Binning and Taxonomy"}
:::
::::
...
You can find a [more detailed version of the workflow](/docs/miscellanea/extras/workflow03.qmd) we will be following by going to `Extras` and selecting `Workflow Reference`. This diagram contains all of the steps followed over the course alongside program names.
