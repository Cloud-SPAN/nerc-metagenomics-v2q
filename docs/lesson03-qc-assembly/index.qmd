...
![](/images/03_short_analysis_flowchart_short_asm.png){fig-align="center" width="450" fig-alt="Analysis flow diagram that shows the steps:  Sequence reads, Quality control and assembly."}
