...
This means we should use the `--nano-raw` option (ONT regular reads, pre-Guppy5 (<20% error)), as the reads were called with a version of Guppy that precedes v5. Guppy is a program used to convert the signals that come out of a sequencer into an actual string of bases. 
