...
They are now ready to be assembled into a metagenome. Genomic assembly is the process of joining smaller fragments of DNA (_i.e._, reads) to make longer segments to try and reconstruct the original genomes.
:::
...
![Analysis flow diagram that shows the steps: Sequence reads, Quality control and assembly.](/images/03_short_analysis_flowchart_short_asm.png){fig-align="right" width="325" height="316" fig-alt="Analysis flow diagram that shows the steps: Sequence reads, Quality control and assembly."}
:::
::::
