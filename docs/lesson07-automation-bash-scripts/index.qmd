...
This lesson is an introduction to computer task automation using Bash scripts. Using the data analysis tasks that you manually ran in the previous lessons as a running example, this lesson shows how to create Bash scripts to run all those tasks automatically one after the other. Thus, you will be able to **run a single script to have done** all your data management and data analysis tasks.

A script is a file that contains all the tasks that you want to be performed, that is: all the shell **commands** (e.g.: `ls`, `mkdir`, `rm`, etc.) and **programs** (e.g., `fastqc`, `flye`, `pilon`, etc.) that you know need to be run in order for you to get your analysis done.  
...
Scripts consisting of various tasks are also referred to as **workflows**.

## Overview
This lesson consists of four episodes:
